...
public class APIController extends BaseController {    
    ...
    public void getMessageResponseAsync(
        ...
        APIHelper.appendUrlWithTemplateParameters(_queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 4704256146318940347L;
            {
        ...
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 5711562087119874221L;
            {
    ...
    public void getMessageStatusAsync(
        ...
        //process template parameters
        APIHelper.appendUrlWithTemplateParameters(_queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 4696195694666288472L;
            {
                    put( "messageID", messageID );
            }});
        //validate and preprocess url
        ...
        //load all headers for the outgoing API request
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 5247509841526582727L;
            {
                    put( "user-agent", "APIMATIC 2.0" );
    ...
    public void createSMSMessageAsync(
        ...
        if (null == messageRequest)
            throw new NullPointerException("The parameter \"messageRequest\" is a required parameter and cannot be null.");
        ...
        //load all headers for the outgoing API request
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 4993870957229557973L;
            {
                    put( "user-agent", "APIMATIC 2.0" );
                    put( "accept", "application/json" );
                    put( "Authorization", String.format("Bearer %1$s", Configuration.oAuthAccessToken) );
    ...
    public void getAuthenticationAsync(
        ...
        if (null == input.getClientId())
            throw new NullPointerException("The property \"ClientId\" in the input object cannot be null.");

        if (null == input.getClientSecret())
            throw new NullPointerException("The property \"ClientSecret\" in the input object cannot be null.");
        ...
        APIHelper.appendUrlWithQueryParameters(_queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 5722986926083009216L;
            {
        ...
        //load all headers for the outgoing API request
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 4634023312149811463L;
            {
                    put( "user-agent", "APIMATIC 2.0" );
                    put( "accept", "application/json" );
            }
